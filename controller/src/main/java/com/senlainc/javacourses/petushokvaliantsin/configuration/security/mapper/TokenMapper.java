package com.senlainc.javacourses.petushokvaliantsin.configuration.security.mapper;
    ...
    public UserDetails parseToken(String token) {
        try {
            final String decodedToken = JWT.require(HMAC512(secretKey.getBytes()))
                    ...
                    .getSubject();
            return userDetailsService.loadUserByUsername(new ObjectMapper().readValue(decodedToken, UserCredDto.class).username());
        } catch (Exception exc) {
            return null;
        }
    }
