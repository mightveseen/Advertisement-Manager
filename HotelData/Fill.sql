USE HotelBase;
INSERT INTO `Attendance`(`name`, `section`, `price`)
VALUES 
	('Lunch', 'Food', 12.3),
	('Dinner', 'Food', 21.0),
    ('Breakfast', 'Food', 9.0),
    ('Playstation 4', 'Entertainment', 20.5);
INSERT INTO `Room`(`number`, `classification`, `room_number`, `capacity`, `status`, `price`)
VALUES 
...
INSERT INTO `OrderAttendance`(`order_id`, `attendance_id`)
VALUES
	(1, 1),
    (1, 4),
    (1, 2),
